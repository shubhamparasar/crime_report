                    ...
                    <table cellpadding="0" cellspacing="0" class="auto-style25">
                        <tr>
                            ...
                            <td class="auto-style27">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtemail" ErrorMessage="invalid id" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style26">AadharId</td>
                            <td class="auto-style27">
                        ...
                        <tr>
                            ...
                            <td class="auto-style27">
                                <asp:Button ID="btnpass" runat="server" OnClick="Button1_Click" 
                                    Text="Show Password" />
                            </td>
                        </tr>
                    </table>

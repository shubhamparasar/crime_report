...
public partial class admgrid : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        TextBox txtid = (TextBox)GridView1.Rows[rowno].Cells[8].Controls[0];
        TextBox txtname = (TextBox)GridView1.Rows[rowno].Cells[1].Controls[0];
        TextBox txtthanaid = (TextBox)GridView1.Rows[rowno].Cells[2].Controls[0];

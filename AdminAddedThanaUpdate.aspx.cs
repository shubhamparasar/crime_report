...
public partial class AdminAddedThanaUpdate : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        clsAddthanaAdmin objcate = new clsAddthanaAdmin();
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        TextBox txtemail = (TextBox)GridView1.Rows[rowno].Cells[3].Controls[0];
        TextBox txtct = (TextBox)GridView1.Rows[rowno].Cells[4].Controls[0];
        TextBox txtoff = (TextBox)GridView1.Rows[rowno].Cells[5].Controls[0];
        TextBox txtpin = (TextBox)GridView1.Rows[rowno].Cells[6].Controls[0];
        clsAddthanaAdmin objcate = new clsAddthanaAdmin();
        ...
        objcate.OfficerName = txtoff.Text;

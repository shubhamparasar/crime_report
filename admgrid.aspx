<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admgrid.aspx.cs" Inherits="admgrid" %>
        ...
        <table cellpadding="0" cellspacing="0" class="auto-style18">
            <tr>
                ...
                <td class="auto-style20" rowspan="6">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdated="GridView1_RowUpdated" OnRowUpdating="GridView1_RowUpdating" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="1" style="top: 278px; left: 293px; position: absolute; height: 171px; width: 908px">

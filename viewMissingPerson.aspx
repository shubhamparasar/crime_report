<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewMissingPerson.aspx.cs" Inherits="viewMissingPerson" %>
    ...
    <form id="form2" runat="server">
     ...
     <center>
        <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" 
            ...
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None" style="margin-left: 0px" Width="160px" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="MissingPersonName" HeaderText="Name" ReadOnly="True" SortExpression="MissingPersonName" />
                <asp:BoundField DataField="ContactNo" HeaderText="Contact No" ReadOnly="True" SortExpression="ContactNo" />
                <asp:BoundField DataField="psID" HeaderText="Thana ID" ReadOnly="True" SortExpression="psID" />

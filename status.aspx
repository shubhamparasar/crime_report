    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" class="auto-style18">
            <tr>
                ...
                <td class="auto-style20" rowspan="5">
                    <p class="auto-style25">
                        <table class="auto-style1">
                            <tr>
                                <td class="auto-style27">ThanaId</td>
                                <td>
                                    <asp:TextBox ID="txtthanaid" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style27">ThanaName</td>
                                <td>
                                    <asp:TextBox ID="txtname" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style27">FIRNo</td>
                                <td>
                        ...
                        <strong><h1>
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/download.jpg" Width="148px" OnClick="ImageButton1_Click" />
                    </h1></strong></p>
                </td>
            </tr>
            <tr>

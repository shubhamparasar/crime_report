<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MostWanted_VUD_Admin.aspx.cs" Inherits="MostWanted_VUD_Admin" %>
...
<!DOCTYPE html>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100px" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="thanaId" HeaderText="Thana Id" SortExpression="thanaId" />
                <asp:BoundField DataField="Name" HeaderText="Thana Name" SortExpression="Name" />
                <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
                <asp:BoundField DataField="LastSpotted" HeaderText="LastSpotted" SortExpression="LastSpotted" />

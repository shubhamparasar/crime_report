...
public partial class missing_vud : System.Web.UI.Page
{
   ...
   // lblmsg.Text +="Value="+  DropDownList1.SelectedItem.Value;*/
    ...
    protected void GridView1_RowUpdating1(object sender, GridViewUpdateEventArgs e)
    {
        ...
        TextBox txtdesc = (TextBox)GridView1.Rows[rowno].Cells[3].Controls[0];
        TextBox txtcn = (TextBox)GridView1.Rows[rowno].Cells[4].Controls[0];
        clsRegistrationMissing objcate = new clsRegistrationMissing();
